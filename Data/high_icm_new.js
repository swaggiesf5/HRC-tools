...
// High ICM
//===========================================================================================================================================
const IS_HIGH_ICM = true; // Set to false to deactivate the high ICM functionality
const COVER_STACK_RATIO = 1.1 // If A stack >= B stack * COVER_STACK_RATIO, A can pressure B
...
let SIZES_3BET = {
    ...
    'IPSmall': {
        15: "2.0x + 0.5bb, All-In",
		20: "2.0x + 0.5bb, All-In",
        25: "2.25x + 0.5bb, All-In",
        30: "2.5x + 0.5bb, All-In",
        35: "2.75x + 0.5bb, All-In",
        40: "3.0x + 0.5bb, All-In",
        60: "3.25x + 1.0bb, All-In",
        80: "3.5x + 1.0bb, All-In",
        100: "3.5x + 1.0bb, All-In",
        'default': "3.75x + 1.0bb, All-In"
    },
    'IPLarge': {
...
function getSizingsOpening(ctx) {
    ...
    let behindPlayerStackSizeBB = null
    ...
    if (playerIsSB) {
        if (ctx.getFlatCallCount() > 0) {
            ...
            } else if (playerStackSizeBB >= behindPlayerStackSizeBB * COVER_STACK_RATIO) {
                sizing = SIZES_OPEN['SBvsBBSmall'][sizingKey];
            } else {
                sizing = SIZES_OPEN['SBvsBBLarge'][sizingKey];
            }
        }
    } else if (playerIsBB) {
        if (ctx.getFlatCallCount() > 0) {
            ...
            if (!IS_HIGH_ICM) {
                ...
                sizing = SIZES_OPEN['BBvsSBSmall'][sizingKey];
            } else {
                sizing = SIZES_OPEN['BBvsSBLarge'][sizingKey];
            }
        }
    } else {
...
function getSizings3Bets(ctx) {
    ...
    if (IS_HIGH_ICM) {
        if (playerStackSizeBB >= raiserStackSizeBB * COVER_STACK_RATIO) {
            scenarioKey += 'Small';
        } else {
            scenarioKey += 'Large';
        }

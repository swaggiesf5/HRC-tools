#!/usr/bin/env bash
# HRC Automator (Linux/xdotool) — 300 players, stone_bubble spot — high_icm_new.js
#
...
INPUT_DIR="/home/ec2-user/Documents/Hands/output_hands/300/stone_bubble"   # instance hands dir

#!/usr/bin/env bash
# HRC Automator (Linux/xdotool) — 300 players, final_table_8_max spot — high_icm_new.js
#
...
INPUT_DIR="/home/ec2-user/Documents/Hands/output_hands/300/final_table_8_max"   # instance hands dir

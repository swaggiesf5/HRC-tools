#!/usr/bin/env bash
# HRC Automator (Linux/xdotool) — 300 players, final_3_table spot — high_icm_new.js
#
...
INPUT_DIR="/home/ec2-user/Documents/Hands/output_hands/300/final_3_table"   # instance hands dir

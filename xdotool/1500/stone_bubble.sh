#!/usr/bin/env bash
# HRC Automator (Linux/xdotool) — 1500 players, stone_bubble spot — high_icm_new.js
#
...
INPUT_DIR="/home/ec2-user/Documents/Hands/output_hands/1500/stone_bubble"   # instance hands dir
